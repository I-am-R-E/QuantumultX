# ⚠️ 3 People Who Have Forked This Project Have Been Blocked
# ⚠️ 已拉黑了3个Fork本项目的人
...
| :----: | :----: | :----: | :----: | :----: |
|[Copy Node List](https://raw.githubusercontent.com/I-am-R-E/QuantumultX/main/AgentNode/NeteaseMusicUnlock.list)| 2022.02.13 | The node comes from the Internet, and can only unlock NetEase Cloud Music, but cannot be used as an agent, and the node is owned by the node provider.<br><br>只能解锁网易云音乐,不能够用于其他代理,节点来自互联网归提供者所有.| Seven<br>7| 🟢 | 
...
TextEditor |  [Download](https://apps.apple.com/us/app/text-editor/id1483790257) | 1.4.0 | Unlock Subscription<br><br>解锁订阅 | 🟢 | [Copy Link](https://raw.githubusercontent.com/I-am-R-E/QuantumultX/main/TextEditor.conf)|
...
🔴 CopyLink And Subscription Rewrite For QuantumultX/ 复制链接,圈X订阅到重写里面去
